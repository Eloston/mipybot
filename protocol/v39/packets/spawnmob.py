...
class handler(template.handler):
    ...
    def getlength(self, roboclass, data):
        ...
        print("Mob Type:", roboclass.CONVERTER.getbyte(data, Position, False))
        Position += roboclass.CONVERTER.BYTE_LENGTH
        Position += roboclass.CONVERTER.INTEGER_LENGTH*3 + roboclass.CONVERTER.BYTE_LENGTH*3 + roboclass.CONVERTER.SHORT_LENGTH*3
